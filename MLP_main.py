...
from model.MLP_model_tensorflow import train, predict
...
if __name__=="__main__":
    ...
    figure_save_path = log_save_path+"/MLP_figure/"
    model_save_path = log_save_path+"/MLP_model/"

    log_save_path = log_save_path + "/MLP_" + data_name + '_'+ str(train_num)+ ".log"
