...
from model.DNM_model_tensorflow import train, predict
...
if __name__=="__main__":
    ...
    parser.add_argument("-d", "--train_data_path", default='./data2/英国富时100指数历史数据.csv', type=str, help="train_data_path")
    ...
    figure_save_path = log_save_path+"/DNM_figure/"
    model_save_path = log_save_path+"/DNM_model/"

    log_save_path = log_save_path + "/DNM_" + data_name + '_'+ str(train_num)+ ".log"
