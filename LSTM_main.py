...
from model.LSTM_model_tensorflow import train, predict
...
if __name__=="__main__":
    ...
    figure_save_path = log_save_path+"/LSTM_figure/"
    model_save_path = log_save_path+"/LSTM_model/"

    log_save_path = log_save_path + "/LSTM_" + data_name + '_'+ str(train_num)+ ".log"
